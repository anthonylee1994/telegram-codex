...
@WebMvcTest(
    ...
    properties = "logging.level.com.telegramcodex.web.TelegramWebhookController=OFF"
)
@Import(TelegramWebhookControllerTest.TestConfig.class)
class TelegramWebhookControllerTest {

    @TestConfiguration
    @EnableConfigurationProperties(com.telegramcodex.config.AppProperties.class)
