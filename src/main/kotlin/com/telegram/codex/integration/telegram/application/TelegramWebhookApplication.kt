...
class InboundMessageProcessor(
    ...
    private val processingSteps = listOf<ProcessingStep>(
        ...
        ProcessingStep { message, update -> handleDuplicateUpdate(message) },
        ProcessingStep { message, update -> handleTelegramCommand(message) },
        ProcessingStep { message, update -> handleBlockedReplyRequest(message) },
    )
    ...
    private fun handleDuplicateUpdate(message: InboundMessage): Boolean =
        duplicateUpdateHandler.handle(message)

    private fun handleTelegramCommand(message: InboundMessage): Boolean =
        telegramCommandHandler.handle(message)

    private fun handleBlockedReplyRequest(message: InboundMessage): Boolean =
