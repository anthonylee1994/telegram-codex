...
import com.telegramcodex.persistence.ChatMemoryEntity;
import com.telegramcodex.persistence.ChatMemoryJpaRepository;
...
public class ChatMemoryRepository {
    ...
    public Optional<ChatMemoryRecord> find(String chatId) {
        return repository.findById(chatId)
            .map(entity -> new ChatMemoryRecord(entity.getChatId(), entity.getMemoryText(), entity.getUpdatedAt()));
    }
