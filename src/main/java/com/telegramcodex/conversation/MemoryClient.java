...
import com.telegramcodex.codex.ExecRunner;
...
public class MemoryClient {
    ...
    public String merge(String existingMemory, String userMessage, String assistantReply) {
        String rawReply = execRunner.run(buildPrompt(existingMemory, userMessage, assistantReply), java.util.List.of(), memoryOutputSchema());
        try {
    ...
    private Map<String, Object> memoryOutputSchema() {
        return Map.of(
            ...
            "required", java.util.List.of("memory"),
