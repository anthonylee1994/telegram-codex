...
public class CliClient {
    ...
    public CliClient(ExecRunner execRunner, ObjectMapper objectMapper, PromptBuilder promptBuilder, ReplyParser replyParser, UserMessageBuilder userMessageBuilder) {
