class Conversation::Webhooks::ActionExecutor
  def initialize(
    ...
    @actions = {
      ...
      reset_memory: Conversation::Webhooks::Action::ResetMemory.new(**shared_dependencies),
      ...
      show_memory: Conversation::Webhooks::Action::ShowMemory.new(**shared_dependencies),
