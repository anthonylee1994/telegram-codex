...
class Conversation::ReplyGenerationFlow
  ...
  def initialize(
    ...
    telegram_client:,
    pdf_page_rasterizer: Documents::PdfPageRasterizer.new(max_pages: AppConfig.fetch.max_pdf_pages),
    text_document_extractor: Documents::TextDocumentExtractor.new
  )
  ...
  def call(message)
    ...
    rescue Documents::TextDocumentExtractor::MissingDependencyError => e
      @conversation_service.clear_processing(message.update_id) unless has_pending_reply
